...
let emailMessages =
{
  ...
  "destroyer":"dear you,\r\n he makes it seem easy doesn't it? like look at this https://brightestyoungthings.com/articles/destroyer-pornographer-bejar. incredible. how do i get there, where i can light a cigarette or crack open a gennessee on stage in front of thousands, screaming about notorious lightning or whatever's gotten into sunny?\r\nlove, me",
...
function setButtons(id)
{
  ...
  if(id == "lsd")
  {
    ...
    {
      media.src = "media/audio/acid1.wav";
      media.play();
...
function showPorn()
{
  ...
  {
    media.src = "media/audio/goon.wav";
    media.play();
    mediaButton.style.display = "inherit";
    mediaButton.src = "media/nav/pause.png";
    for(var x = 0; x < 15; x++)
